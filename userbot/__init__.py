...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/KGPROJE/KG-UBOT")
UPSTREAM_REPO_BRANCH = os.environ.get(
    "UPSTREAM_REPO_BRANCH", "KG-UBOT")
...
# Bot Name
TERM_ALIAS = os.environ.get("TERM_ALIAS", "KG-UBOT")
                ...
                await ken.tgbot.send_file(event.chat_id, file=logo,
                                          ...
                                          buttons=[
                                              [
                                                  custom.Button.url(
                                                      text="Rᴇᴘᴏ",
                                                      url="https://github.com/KGPROJE/KG-UBOT"),
                                                  custom.Button.url(
                                                      text="Lɪsᴇɴsɪ​",
                                                      url="https://github.com/KGPROJE/KG-UBOT/blob/KG-UBOT/LICENSE"
                                                  )
                                              ]
                                          ]
                                          )
